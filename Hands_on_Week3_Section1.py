...
Welcome 11  times. To stop press [CTRL+C]
Welcome 12  times. To stop press [CTRL+C]
Welcome 13  times. To stop press [CTRL+C]
Welcome 14  times. To stop press [CTRL+C]
Welcome 15  times. To stop press [CTRL+C]
Welcome 16  times. To stop press [CTRL+C]
Welcome 17  times. To stop press [CTRL+C]
Welcome 18  times. To stop press [CTRL+C]
Welcome 19  times. To stop press [CTRL+C]
Welcome 20  times. To stop press [CTRL+C]
Welcome 21  times. To stop press [CTRL+C]
Traceback (most recent call last):
  File "<pyshell#119>", line 4, in <module>
    time.sleep(2)
KeyboardInterrupt
>>> for i in "Python":
	print(i, end = "-")
